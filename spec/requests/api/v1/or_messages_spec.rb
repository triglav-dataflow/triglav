...
RSpec.describe 'OrMessage resources', :type => :request do
  ...
  describe "Fetch OR messages", :autodoc do

    let(:description) do
      "Fetch OR messages whose message id is greater than or equal to offset<br/>" \
      "<br/>" \
  ...
  describe "Get last OR message id", :autodoc do

    let(:description) do
      "Get last OR message id which would be used as a first offset to fetch messages<br/>"
    end
